...
<template>
  <v-container>
    <v-alert type="error" text border="left" :title="$t('errors.playerNameUnset.title')" v-if="playerName == false">
      {{ $t("errors.playerNameUnset.message") }}
    </v-alert>
    <v-alert type="error" text border="left" :title="$t('errors.homeDirUnset.title')" v-if="homeDir == false">
      {{ $t("errors.homeDirUnset.message") }}
    </v-alert>
    <v-alert type="error" text border="left" :title="$t('errors.nasUnset.title')" v-if="nas == false">
